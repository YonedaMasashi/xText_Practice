...
{ before(grammarAccess.getQuestionAccess().getContentsQuestionContentParserRuleCall_3_0()); }
	rulequestionContent{ after(grammarAccess.getQuestionAccess().getContentsQuestionContentParserRuleCall_3_0()); }
)
...
{ before(grammarAccess.getChooseFromAccess().getChoicesSTRINGTerminalRuleCall_2_0()); }
	RULE_STRING{ after(grammarAccess.getChooseFromAccess().getChoicesSTRINGTerminalRuleCall_2_0()); }
)
