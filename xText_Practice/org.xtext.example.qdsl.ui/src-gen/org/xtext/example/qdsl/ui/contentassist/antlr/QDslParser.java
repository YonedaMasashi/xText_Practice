		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getQuestionAccess().getContentsAssignment_3(), "rule__Question__ContentsAssignment_3");
					...
					put(grammarAccess.getChooseFromAccess().getChoicesAssignment_2(), "rule__ChooseFrom__ChoicesAssignment_2");
				}
			};
		}
